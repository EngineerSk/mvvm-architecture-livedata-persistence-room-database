...
import com.engineersk.mvvmarchitecture.adapter.NoteRecyclerAdapter;
...
public class MainActivity extends AppCompatActivity implements NoteRecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mAddNoteButton = findViewById(R.id.add_note_fab);
        this.mAddNoteButton.setOnClickListener(v -> {
        ...
        this.mNoteViewModel.getAllNotes().observe(this,
                notes -> {
                    ...
                    this.mNoteRecyclerAdapter.setNotes(notes);
                });
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                MainActivity.this.mNoteViewModel
                        .delete(MainActivity.this.mNoteRecyclerAdapter
        ...
        mNoteRecyclerAdapter.setOnItemClickListener(this);
    }
    ...
    private void initializeRecyclerView() {
        ...
        this.mNoteRecyclerAdapter = new NoteRecyclerAdapter();
        this.mRecyclerView.setAdapter(this.mNoteRecyclerAdapter);
    }
